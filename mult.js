(function () {
    ...
    function addAnimationButton() {
        ...
        menuItem.innerHTML = `
            <div class="menu__ico menu-animation">
        ...
        `;
        menuItem.addEventListener("click", loadAnimationPage);
    ...
    // Функция для открытия страницы мультфильмов
    function loadAnimationPage() {
        console.log('Открытие страницы Мультфильмов');

        // Создаем структуру страницы
        const pageContent = document.createElement('div');
        pageContent.className = 'animation-page';

        const pageTitle = document.createElement('h1');
        pageTitle.innerText = 'Мультфильмы';
        pageContent.appendChild(pageTitle);

        // Место для списка мультфильмов
    ...
    function fetchAnimationMovies(moviesList) {
        // Для примера добавим несколько мультфильмов
        const exampleMovies = [
            { title: "Мультфильм 1", release_date: "2024-01-01", poster_path: "https://via.placeholder.com/150" },
            { title: "Мультфильм 2", release_date: "2024-01-02", poster_path: "https://via.placeholder.com/150" }
        ];
