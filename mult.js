(function () {
    ...
    function addMenuButton() {
        console.log("Добавление кнопки в меню...");

        // Создаем элемент меню с SVG иконкой
        const menuItem = $(
            '<li class="menu__item selector" data-action="animation">' +
        ...
        try {
            ...
            console.log("Кнопка 'Мультфильмы' успешно добавлена.");
        } catch (e) {
            console.error("Ошибка при добавлении кнопки в меню:", e);
        }
    }

    // Запуск плагина, когда приложение готово
    if (window.appready) {
        addMenuButton();
    } else {
