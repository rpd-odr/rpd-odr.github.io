!function() {
    ...
    // Проверка готовности Lampa и jQuery
    var check = setInterval(function() {
        if (typeof Lampa !== 'undefined' && Lampa.Listener && typeof $ !== 'undefined') {
            clearInterval(check);
            init();
            console.log("mult.js: Инициализация выполнена");
        } else {
            console.log("mult.js: Ожидание зависимостей...");
        }
    }, 200);
}();
